...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Myboxx[/B][/COLOR]Wizard'
BUILDERNAME = 'MyboxxWizard'
EXCLUDES = [ADDON_ID, 'repository.myboxx']
# Text File with build info in it.
BUILDFILE = 'http://http://myboxx.live/build/builds.txt'
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing MyboxxWizard.\n\nContact us at look@myboxx.live'
...
REPOID = 'repository.myboxx'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'http://myboxx.live/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'http://myboxx.live/master/zips/repository.myboxx/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Wizard[/B][/COLOR]Wizard'
